...
import { Users, Clock, Calendar, AlertTriangle, User } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div key={i} className="flex items-center justify-between border-b pb-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Entrada registrada</p>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Solicitações Pendentes</h3>
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center justify-between border-b pb-4">
                <div>
                  <p className="text-sm font-medium text-gray-900">Alteração de Horário</p>
                  <p className="text-xs text-gray-500">Carlos Oliveira - TI</p>
                </div>
